...
export default function Signup() {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 transition-colors overflow-auto flex items-center justify-center p-4">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400">
                Join thousands of users breaking communication barriers with AI-powered translation
              </p>
            </div>
            <div className="space-y-4 pt-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-900 dark:text-white">Free to Start</p>
                  <p className="text-xs text-gray-600 dark:text-gray-400">No credit card required</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-900 dark:text-white">Instant Setup</p>
                  <p className="text-xs text-gray-600 dark:text-gray-400">Start translating in minutes</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400">We're here to help anytime</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start">
              <input
                type="checkbox"
                required
                className="w-4 h-4 mt-0.5 text-blue-600 border-gray-300 dark:border-gray-700 rounded focus:ring-blue-500 dark:bg-gray-800"
              />
